const FeatureSection = () => {
  return (
 <div>
     <div className="mx-20 mt-28 mb-28" >
        <h2 className="text-5xl font-bold text-center mb-24">Feature Section</h2>
      <div className="grid grid-cols-4">
      <div className=" skeleton card w-96  shadow-xl ml-10 bg-red-300">
      ...
      <div className="skeleton card w-96  shadow-xl bg-yellow-300">
      ...
      <div className="skeleton card w-96  shadow-xl bg-amber-300">
      ...
      <div className="skeleton card w-96  shadow-xl bg-orange-300">
    ...
    <div className="mx-20 mt-28 mb-28" >
      ...
      <div className="grid grid-cols-4">
      <div className=" skeleton card w-96  shadow-xl ml-10 bg-lime-300">
      ...
      <div className="skeleton card w-96  shadow-xl bg-green-300">
      ...
      <div className="skeleton card w-96  shadow-xl bg-emerald-300">
      ...
      <div className="skeleton card w-96  shadow-xl bg-cyan-300">
